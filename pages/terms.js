...
export default function Terms() {
  return (
    <>
      <Head>
        <title>Terms of Service — Swad Bhandar</title>
      </Head>
      <header>
        <nav className="nav">
      ...
      <div className="legal-page">
        ...
        <h2>1. About Us</h2>
        <p>Swad Bhandar is a home-based food business selling traditional Bihari snacks, including Thekua in various flavors and weights. By using this website, you agree to these Terms of Service.</p>
        ...
        <p>Swad Bhandar is not liable for any indirect or consequential loss arising from the use of this website or delays in delivery due to circumstances beyond our control.</p>
